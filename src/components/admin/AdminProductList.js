          ...
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex justify-center text-sm border border-gray-200 p-2 py-1 font-medium text-gray-700 hover:text-gray-900">
                    Sort
                    <ChevronDownIcon
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <div>
                  <Link
                    to="/dashboard/admin/product-form"
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products.map((product) => (
            <div key={product.id}>
              ...
              <div className="mt-5">
                <Link
                  to={`/dashboard/admin/product-form/edit/${product.id}`}
